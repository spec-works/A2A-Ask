...
### Added
- Catalog bridge lifecycle commands: `a2a-ask catalog install`, `catalog uninstall`, `catalog installed`, and `catalog sync`
- Copilot bridge installation workflow with `remote-agent` frontmatter, auth pre-flight warnings, and bridge refresh support
